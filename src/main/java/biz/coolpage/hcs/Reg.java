...
public class Reg implements ModInitializer {
    ...
    public static final IceboxBlock ICEBOX = new IceboxBlock(Settings.copy(Blocks.COBBLESTONE).mapColor(MapColor.WHITE_GRAY).strength(2.0F, 3.0F).requiresTool().nonOpaque());
    public static final Item ICEBOX_ITEM = new BlockItem(ICEBOX, new Item.Settings());
    public static final DryingRackBlock DRYING_RACK = new DryingRackBlock(AbstractBlock.Settings.copy(Blocks.OAK_FENCE).mapColor(MapColor.BROWN).strength(1.5F, 2.0F).requiresTool().nonOpaque());
    ...
    public static final CrudeTorchBlock CRUDE_TORCH_BLOCK = new CrudeTorchBlock(Settings.copy(Blocks.TORCH).noCollision().breakInstantly().luminance(state -> 0).sounds(BlockSoundGroup.WOOD));
    public static final WallCrudeTorchBlock WALL_CRUDE_TORCH_BLOCK = new WallCrudeTorchBlock(Settings.copy(Blocks.WALL_TORCH).noCollision().breakInstantly().luminance(state -> 0).sounds(BlockSoundGroup.WOOD).dropsLike(CRUDE_TORCH_BLOCK));
    ...
    public static final BurningCrudeTorchBlock BURNING_CRUDE_TORCH_BLOCK = new BurningCrudeTorchBlock(Settings.copy(Blocks.TORCH).noCollision().breakInstantly().luminance(state -> 13).sounds(BlockSoundGroup.WOOD));
    public static final WallBurningCrudeTorchBlock WALL_BURNING_CRUDE_TORCH_BLOCK = new WallBurningCrudeTorchBlock(Settings.copy(Blocks.WALL_TORCH).noCollision().breakInstantly().luminance(state -> 13).sounds(BlockSoundGroup.WOOD).dropsLike(BURNING_CRUDE_TORCH_BLOCK));
    public static final Item BURNING_CRUDE_TORCH_ITEM = new BurningCrudeTorchItem();
    public static final UnlitTorchBlock UNLIT_TORCH_BLOCK = new UnlitTorchBlock(Settings.copy(Blocks.TORCH).luminance(state -> 0).noCollision().breakInstantly().sounds(BlockSoundGroup.WOOD));
    public static final WallUnlitTorchBlock WALL_UNLIT_TORCH_BLOCK = new WallUnlitTorchBlock(Settings.copy(Blocks.WALL_TORCH).noCollision().breakInstantly().sounds(BlockSoundGroup.WOOD).dropsLike(UNLIT_TORCH_BLOCK));
...
//        LootHelper.init();
        ...
        Registry.register(Registries.ITEM_GROUP, HCS_ITEM_GROUP, FabricItemGroup.builder().displayName(Text.translatable("itemGroup.hcs.main")).icon(() -> new ItemStack(FLINT_HATCHET)).entries((context, entries) -> {
            ...
            entries.add(new ItemStack(FIBER_STRING));
            entries.add(new ItemStack(SHORT_STICK));
            entries.add(new ItemStack(TINDER));
            entries.add(new ItemStack(FIREWOOD));
            entries.add(new ItemStack(FIRE_PLOUGH));
            entries.add(new ItemStack(FIRE_BOW));
            entries.add(new ItemStack(EXTINGUISHED_CAMPFIRE));
            entries.add(new ItemStack(SMOLDERING_CAMPFIRE));
            entries.add(new ItemStack(BURNT_CAMPFIRE));
            entries.add(new ItemStack(ASHES));
            entries.add(new ItemStack(ROCK));
            entries.add(new ItemStack(SHARP_ROCK));
            entries.add(new ItemStack(SHARP_FLINT));
            entries.add(new ItemStack(RAW_COPPER_POWDER));
            entries.add(new ItemStack(Items.WOODEN_SWORD));
            entries.add(new ItemStack(SPIKED_CLUB));
            entries.add(new ItemStack(SHARP_BROKEN_BONE));
            entries.add(new ItemStack(STONE_CONE));
            entries.add(new ItemStack(STONE_KNIFE));
            entries.add(new ItemStack(STONE_SPEAR));
            entries.add(new ItemStack(FLINT_CONE));
            entries.add(new ItemStack(FLINT_KNIFE));
            entries.add(new ItemStack(FLINT_SPEAR));
            entries.add(new ItemStack(FLINT_HATCHET));
            entries.add(new ItemStack(COPPER_SWORD));
            entries.add(new ItemStack(COPPER_AXE));
            entries.add(new ItemStack(COPPER_PICKAXE));
            entries.add(new ItemStack(COPPER_HOE));
            entries.add(new ItemStack(COPPER_SHOVEL));
            entries.add(new ItemStack(COPPER_HELMET));
            entries.add(new ItemStack(COPPER_CHESTPLATE));
            entries.add(new ItemStack(COPPER_LEGGINGS));
            entries.add(new ItemStack(COPPER_BOOTS));
            entries.add(new ItemStack(WOOLEN_HOOD));
            entries.add(new ItemStack(WOOLEN_COAT));
            entries.add(new ItemStack(WOOLEN_TROUSERS));
            entries.add(new ItemStack(WOOLEN_BOOTS));
            entries.add(new ItemStack(WOODEN_HELMET));
            ...
            entries.add(new ItemStack(ROASTED_WORM));
            entries.add(new ItemStack(BAT_WINGS));
            entries.add(new ItemStack(ROASTED_BAT_WINGS));
            entries.add(new ItemStack(RAW_MEAT));
            entries.add(new ItemStack(COOKED_MEAT));
            entries.add(new ItemStack(ANIMAL_VISCERA));
            entries.add(new ItemStack(COOKED_ANIMAL_VISCERA));
            entries.add(new ItemStack(CACTUS_FLESH));
            entries.add(new ItemStack(COOKED_CACTUS_FLESH));
            entries.add(new ItemStack(BAMBOO_SHOOT));
            entries.add(new ItemStack(COOKED_BAMBOO_SHOOT));
            entries.add(new ItemStack(PUMPKIN_SLICE));
            entries.add(new ItemStack(COOKED_PUMPKIN_SLICE));
            entries.add(new ItemStack(ROASTED_SEEDS));
            entries.add(new ItemStack(COOKED_CARROT));
            entries.add(new ItemStack(COOKED_SWEET_BERRIES));
            entries.add(new ItemStack(FRIED_EGG));
            entries.add(new ItemStack(COOKED_KELP));
            entries.add(new ItemStack(POTHERB));
            entries.add(new ItemStack(ORANGE));
            entries.add(new ItemStack(GINGER));
            entries.add(new ItemStack(PETALS_SALAD));
            entries.add(new ItemStack(JERKY));
            entries.add(new ItemStack(SMALL_JERKY));
            entries.add(new ItemStack(RAW_JERKY));
            entries.add(new ItemStack(RAW_SMALL_JERKY));
            entries.add(new ItemStack(ROT));
            entries.add(new ItemStack(SELAGINELLA));
            entries.add(new ItemStack(SPIDER_GLAND));
            entries.add(new ItemStack(BERRY_BUSH));
            entries.add(new ItemStack(BARK));
            entries.add(new ItemStack(WILLOW_BARK));
            entries.add(new ItemStack(FEARLESSNESS_HERB));
            entries.add(new ItemStack(IMPROVISED_BANDAGE));
            entries.add(new ItemStack(BANDAGE));
            entries.add(new ItemStack(HEALING_SALVE));
            entries.add(new ItemStack(SPLINT));
            entries.add(new ItemStack(BOOSTER_SHOT));
            entries.add(new ItemStack(PURIFIED_WATER_BOTTLE)); //prev: .getDefaultStack()
            entries.add(new ItemStack(SALTWATER_BOTTLE));
            entries.add(new ItemStack(COLD_WATER_BOTTLE));
            entries.add(new ItemStack(CACTUS_JUICE));
            entries.add(PotionUtil.setPotion(new ItemStack(Items.POTION), IRONSKIN_POTION));
            entries.add(PotionUtil.setPotion(new ItemStack(Items.POTION), RETURN_POTION));
            entries.add(PotionUtil.setPotion(new ItemStack(Items.POTION), MINING_POTION));
            entries.add(PotionUtil.setPotion(new ItemStack(Items.POTION), CONSTANT_TEMPERATURE_POTION));
            entries.add(PotionUtil.setPotion(new ItemStack(Items.POTION), PAIN_KILLING_POTION));
            entries.add(PotionUtil.setPotion(new ItemStack(Items.POTION), FEARLESSNESS_POTION));
            entries.add(new ItemStack(ICEBOX_ITEM));
            entries.add(new ItemStack(DRYING_RACK_ITEM));
            entries.add(new ItemStack(CRUDE_TORCH_ITEM));
            entries.add(new ItemStack(BURNING_CRUDE_TORCH_ITEM));
            entries.add(new ItemStack(UNLIT_TORCH_ITEM));
            entries.add(new ItemStack(GLOWSTONE_TORCH_ITEM));
        }).build());
